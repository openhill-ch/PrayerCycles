...
export const en: Translations = {
  ...
  qListName: 'What do you want to call this list?',
  qHowOften: 'How often do you want to pray through this list?',
  ...
  peopleHelp: 'One name per line. You can always add more later.',
