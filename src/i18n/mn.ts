...
export const mn: Translations = {
  ...
  qListName: 'Энэ жагсаалтыг юу гэж нэрлэх вэ?',
  qHowOften: 'Энэ жагсаалтаар хэр давтамжтай залбирах вэ?',
  ...
  peopleHelp: 'Мөр бүрт нэг нэр. Дараа нь бас нэмж болно.',
  ...
  themeSakura: '桜 (Интоорын цэцэг)',
  themeKyoto: '京都 (Киото)',
  themeChikurin: '竹林 (Хулсны ой)',
  themeNewSmyrna: 'New Smyrna Beach (Нью Смирна)',
  themeBirch: 'Wisconsin Birch (Висконсины хус)',
  themeBoulderField: "The Boulder Field (Чулуун талбай)",
